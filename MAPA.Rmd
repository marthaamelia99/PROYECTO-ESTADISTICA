...
#NOS QUEDAMOS CON 5 CLUSTERS POTR HCUT(JERARQUICO)
```{r}
...
#vemos que nos quedamos con la técnica jerárquica aglomerativa 
...
GITH = "https://github.com/adrianoshimante1998/PC4viernes/raw/master/UIA_World_Countries_Boundaries.geojson"
...
```{r}
test=merge(mapaMundo, clusterC, by.x='COUNTRYAFF', by.y='VALUE')
...
```{r}
#colores 
myColors=c('red','yellow','darkgreen', 'blue')
plot (mapaMundo, col='black', main ='MAPA')
